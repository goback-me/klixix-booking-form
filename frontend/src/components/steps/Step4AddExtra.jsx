  ...
  return (
    <div className="p-4 sm:p-5 md:p-6 flex flex-col min-w-0">
      <div className="flex-1 flex flex-col">
        <h2 className="text-2xl md:text-3xl text-gray-900 mb-1 break-words">Do you need anything else?</h2>
        <p className="text-gray-600 mb-4 break-words">All prices are Exclusive of GST.</p>
