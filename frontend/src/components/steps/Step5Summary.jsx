    ...
    <div className="p-4 sm:p-5 md:p-6 flex flex-col min-w-0">
      <div className="flex-1 flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
            <h3 className="text-sm font-semibold text-gray-900 mb-3 flex items-center gap-2">
              <Car className="h-4 w-4 text-[rgba(255,77,36,1)]" /> Vehicle details
            </h3>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
          ...
          <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
            <h3 className="text-sm font-semibold text-gray-900 mb-3 flex items-center gap-2">
              <Plus className="h-4 w-4 text-[rgba(255,77,36,1)]" /> Add-ons
            </h3>
        ...
        {carDetails.additionalInfo && (
          <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100 mb-6">
            <h3 className="text-sm font-semibold text-gray-900 mb-2 flex items-center gap-2">
              <FileText className="h-4 w-4 text-[rgba(255,77,36,1)]" /> Additional information
            </h3>
        ...
        <p className="text-center text-xs sm:text-sm text-gray-700 break-words">
          ...
          Need help? Call us at <span className="text-[rgba(255,77,36,1)]"><a href="tel:0736070215">(07) 3607 0215</a></ span>
        </p>
      </div>
    </div>
  )
